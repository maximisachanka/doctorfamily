...
"[project]/src/app/api/services-menu/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function buildMenuTree(categories) {
    return categories.map((category)=>{
        ...
        // Услуги будут отображаться на странице категории, а не в меню
...
async function GET() {
    try {
        // Рекурсивно загружаем дерево категорий (без услуг для оптимизации)
        ...
        const menuData = buildMenuTree(categories);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6f51e171._.js.map