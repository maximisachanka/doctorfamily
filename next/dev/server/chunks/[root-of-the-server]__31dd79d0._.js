...
"[project]/src/app/api/admin/vacancies/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        const vacancy = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].vacancy.update({
            where: {
                id: vacancyId
            },
            data: {
...
async function DELETE(request, { params }) {
    try {
        ...
        const { id } = await params;
        const vacancyId = parseInt(id);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].vacancy.delete({
            where: {
                id: vacancyId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31dd79d0._.js.map