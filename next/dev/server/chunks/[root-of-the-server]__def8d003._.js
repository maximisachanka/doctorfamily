...
async function GET(request, { params }) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(transformedService);
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(request, { params }) {
    try {
        ...
        const { title, subtitle, price, video_url, description, specialist_ids, image_url, image_url_1, image_url_2, image_url_3, image_url_4, service_category_id } = body;
        ...
        const service = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].service.update({
            where: {
                id: serviceId
            },
            data: {
...
async function DELETE(request, { params }) {
    try {
        ...
        const { id } = await params;
        const serviceId = parseInt(id);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].service.delete({
            where: {
                id: serviceId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__def8d003._.js.map