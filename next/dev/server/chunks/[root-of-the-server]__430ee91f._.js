...
"[project]/src/app/api/admin/unread-counts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const unreadFeedbacksCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].feedback.count({
            where: {
                verified: false
            }
        });
        ...
        if (patient.role === 'CHIEF_DOCTOR') {
            unreadLettersCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].letter.count({
                where: {
                    OR: [
                        {
                            is_read: false
        ...
        if ([
            ...
            unreadChatsCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].operatorChat.count({
                where: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__430ee91f._.js.map