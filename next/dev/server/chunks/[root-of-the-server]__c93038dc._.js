...
"[project]/src/app/api/admin/feedbacks/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const totalCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].feedback.count({
            where: whereCondition
        });
        // Получаем отзывы для текущей страницы
        const feedbacks = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].feedback.findMany({
            where: whereCondition,
            orderBy: {
                date: 'desc'
            },
...
async function POST(request) {
    try {
        ...
        const feedback = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].feedback.create({
            data: {
                name: data.name,
                text: data.text,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c93038dc._.js.map