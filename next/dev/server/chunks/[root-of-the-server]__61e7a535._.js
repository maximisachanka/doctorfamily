...
"[project]/src/app/api/operator-chat/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const chats = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].operatorChat.findMany({
            where: unreadOnly ? {
...
async function POST(request) {
    try {
        ...
        const existingChat = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].operatorChat.findFirst({
            where: {
                patient_id: userId,
                status: {
                    in: [
        ...
        if (existingChat) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "У вас уже есть активный чат с оператором",
        ...
        const chat = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].operatorChat.create({
            data: {
                patient_id: userId,
                status: 'WAITING',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__61e7a535._.js.map