...
"[project]/src/app/api/admin/materials/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        const material = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].material.update({
            where: {
                id: materialId
            },
            data: {
...
async function DELETE(request, { params }) {
    try {
        ...
        const { id } = await params;
        const materialId = parseInt(id);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].material.delete({
            where: {
                id: materialId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b3e47a38._.js.map