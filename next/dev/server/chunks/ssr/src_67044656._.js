...
"[project]/src/app/admin/question-categories/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function AdminQuestionCategoriesPage() {
    ...
    const handleSubmit = async ()=>{
        ...
        setFormLoading(true);
        try {
            const url = editingCategory ? `/api/admin/question-categories/${editingCategory.id}` : '/api/admin/question-categories';
    ...
    const filteredCategories = categories.filter((cat)=>cat.name.toLowerCase().includes(searchQuery.toLowerCase()) || cat.slug.toLowerCase().includes(searchQuery.toLowerCase()));
    // Loading state
    if (status === 'loading' || hasAdminRole === null || sessionLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SMAdmin$2f$SMAdminSkeleton$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AdminAccessSkeleton"], {}, void 0, false, {
            fileName: "[project]/src/app/admin/question-categories/page.tsx",
            lineNumber: 226,
            columnNumber: 12
        }, this);
    }
...
//# sourceMappingURL=src_67044656._.js.map