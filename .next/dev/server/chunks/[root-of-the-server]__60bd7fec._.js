...
"[project]/src/app/api/letters/unread/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const lettersWithUnreadReply = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].letter.findMany({
            where: {
                patient_id: userId,
                reply: {
                    not: null
        ...
        const lettersWithUnreadMessages = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].letter.findMany({
            where: {
                patient_id: userId,
                messages: {
                    some: {
        ...
        const allUnreadLetterIds = new Set();
        const allUnreadLetters = [];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__60bd7fec._.js.map