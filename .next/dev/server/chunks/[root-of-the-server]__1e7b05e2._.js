...
"[project]/src/app/api/admin/feedbacks/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        const feedback = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].feedback.update({
            where: {
                id: feedbackId
            },
            data: updateData,
...
async function DELETE(request, { params }) {
    try {
        ...
        const { id } = await params;
        const feedbackId = parseInt(id);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].feedback.delete({
            where: {
                id: feedbackId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1e7b05e2._.js.map