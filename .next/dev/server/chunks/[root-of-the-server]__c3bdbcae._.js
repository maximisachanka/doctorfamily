...
"[project]/src/app/api/admin/users/[id]/block/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        const chiefDoctorId = parseInt(token.id);
        // Проверяем роль - только главный врач
        const chiefDoctor = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patient.findUnique({
            where: {
                id: chiefDoctorId
            },
            select: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            user: updatedUser,
            message: blocked ? `Пользователь "${user.name}" заблокирован` : `Пользователь "${user.name}" разблокирован`
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c3bdbcae._.js.map