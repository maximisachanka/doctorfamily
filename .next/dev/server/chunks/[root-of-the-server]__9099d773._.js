...
"[project]/src/app/api/admin/materials/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const totalCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].material.count({
            where: whereCondition
        });
        // Получаем материалы для текущей страницы
        const materials = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].material.findMany({
            where: whereCondition,
            orderBy: {
                date: "desc"
            },
...
async function POST(request) {
    try {
        ...
        const material = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].material.create({
            data: {
                title: data.title,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9099d773._.js.map