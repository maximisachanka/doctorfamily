...
"[project]/src/app/api/admin/specialists/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        const specialist = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].specialist.update({
            where: {
                id: specialistId
            },
            data: {
...
async function DELETE(request, { params }) {
    try {
        ...
        const { id } = await params;
        const specialistId = parseInt(id);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].specialist.delete({
            where: {
                id: specialistId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dc35a833._.js.map