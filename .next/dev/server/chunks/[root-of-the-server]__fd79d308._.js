...
async function GET(request) {
    try {
        ...
        const totalCount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.count({
            where: whereCondition
        });
        // Получаем вопросы для текущей страницы
        const questions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.findMany({
            where: whereCondition,
            include: {
                service: {
                    select: {
...
async function POST(request) {
    try {
        ...
        const question = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.create({
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fd79d308._.js.map