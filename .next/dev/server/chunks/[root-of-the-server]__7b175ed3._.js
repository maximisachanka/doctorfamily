...
"[project]/src/app/api/admin/question-categories/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const existingSlug = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].questionCategory.findUnique({
            where: {
                slug
            }
        });
        ...
        if (order !== undefined && order !== null) {
            const existingOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].questionCategory.findFirst({
                where: {
        ...
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].questionCategory.create({
            data: {
                name,
                slug,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7b175ed3._.js.map