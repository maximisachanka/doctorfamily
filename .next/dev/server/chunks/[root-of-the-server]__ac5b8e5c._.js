...
"[project]/src/app/api/admin/questions/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PUT(request, { params }) {
    try {
        ...
        const question = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.update({
            where: {
                id: questionId
            },
            data: {
...
async function DELETE(request, { params }) {
    try {
        ...
        const { id } = await params;
        const questionId = parseInt(id);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].question.delete({
            where: {
                id: questionId
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac5b8e5c._.js.map