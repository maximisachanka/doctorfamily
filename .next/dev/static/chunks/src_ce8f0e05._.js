...
function AdminQuestionsPage() {
    ...
    const filteredQuestions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminQuestionsPage.useMemo[filteredQuestions]": ()=>{
            if (!searchQuery) return questions;
            const query = searchQuery.toLowerCase();
            return questions.filter({
                "AdminQuestionsPage.useMemo[filteredQuestions]": (q)=>q.question.toLowerCase().includes(query) || q.answer?.toLowerCase().includes(query) || getCategoryLabel(q.category).toLowerCase().includes(query)
            }["AdminQuestionsPage.useMemo[filteredQuestions]"]);
        }
    }["AdminQuestionsPage.useMemo[filteredQuestions]"], [
        questions,
...
_s(AdminQuestionsPage, "hZuwSE4lj2QdN04bY2fhRcRprbg=", false, function() {
    return [
...
//# sourceMappingURL=src_ce8f0e05._.js.map