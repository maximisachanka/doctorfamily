...
"[project]/src/components/ImageUploader/index.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
function AdminMenu({ onNavigate }) {
    ...
    const { counts } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useUnreadCounts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUnreadCounts"])(30000); // Обновляем каждые 30 секунд
...
_s(AdminMenu, "SgdTFkC0y1kYDJQyf2sgMCOdDd4=", false, function() {
    return [
...
function AdminFeedbacksPage() {
    ...
    // Filtered feedbacks
    const filteredFeedbacks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminFeedbacksPage.useMemo[filteredFeedbacks]": ()=>{
            let result = feedbacks;
            // Filter by status
            if (filterStatus === 'pending') {
                result = result.filter({
                    "AdminFeedbacksPage.useMemo[filteredFeedbacks]": (f)=>!f.verified
                }["AdminFeedbacksPage.useMemo[filteredFeedbacks]"]);
            } else {
                result = result.filter({
                    "AdminFeedbacksPage.useMemo[filteredFeedbacks]": (f)=>f.verified
            ...
            if (searchQuery) {
                ...
                result = result.filter({
                    "AdminFeedbacksPage.useMemo[filteredFeedbacks]": (f)=>f.name.toLowerCase().includes(query) || f.text.toLowerCase().includes(query) || f.service?.title.toLowerCase().includes(query)
                }["AdminFeedbacksPage.useMemo[filteredFeedbacks]"]);
            }
            return result;
        }
    ...
    const pendingCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminFeedbacksPage.useMemo[pendingCount]": ()=>{
            return feedbacks.filter({
                "AdminFeedbacksPage.useMemo[pendingCount]": (f)=>!f.verified
            }["AdminFeedbacksPage.useMemo[pendingCount]"]).length;
        }
    }["AdminFeedbacksPage.useMemo[pendingCount]"], [
        feedbacks
    ]);
    ...
    const paginatedFeedbacks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminFeedbacksPage.useMemo[paginatedFeedbacks]": ()=>{
...
_s(AdminFeedbacksPage, "E5ak9FUmebM6Fc8NBHxbg1Qkn+M=", false, function() {
    return [
...
//# sourceMappingURL=src_148f3d2a._.js.map