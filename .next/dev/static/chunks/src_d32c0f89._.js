...
function AdminPartnersPage() {
    ...
    // Filtered partners
    const filteredPartners = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminPartnersPage.useMemo[filteredPartners]": ()=>{
            if (!searchQuery) return partners;
            const query = searchQuery.toLowerCase();
            return partners.filter({
                "AdminPartnersPage.useMemo[filteredPartners]": (p)=>p.name.toLowerCase().includes(query) || p.description.toLowerCase().includes(query)
            }["AdminPartnersPage.useMemo[filteredPartners]"]);
        }
    }["AdminPartnersPage.useMemo[filteredPartners]"], [
        partners,
    ...
    const paginatedPartners = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminPartnersPage.useMemo[paginatedPartners]": ()=>{
...
_s(AdminPartnersPage, "zdJ6DxvJPYlR0S2WIBtgR8X2h4E=", false, function() {
    return [
...
//# sourceMappingURL=src_d32c0f89._.js.map