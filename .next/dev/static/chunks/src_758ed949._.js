...
function AdminServicesPage() {
    ...
    const filteredServices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminServicesPage.useMemo[filteredServices]": ()=>{
            ...
            return services.filter({
                "AdminServicesPage.useMemo[filteredServices]": (s)=>s.title.toLowerCase().includes(query) || s.subtitle.toLowerCase().includes(query) || (s.serviceCategory?.name?.toLowerCase().includes(query) ?? false)
            }["AdminServicesPage.useMemo[filteredServices]"]);
        }
    }["AdminServicesPage.useMemo[filteredServices]"], [
        services,
    ...
    // Pagination
    const { paginatedData: paginatedServices, totalPages } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminServicesPage.useMemo": ()=>paginateData(filteredServices)
    }["AdminServicesPage.useMemo"], [
        paginateData,
        filteredServices
    ]);
...
_s(AdminServicesPage, "+iQtnGOVp4aO2YAPU64+2S9uNyA=", false, function() {
    return [
...
//# sourceMappingURL=src_758ed949._.js.map