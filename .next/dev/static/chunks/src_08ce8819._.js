...
function AdminVacanciesPage() {
    ...
    // Filtered vacancies
    const filteredVacancies = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminVacanciesPage.useMemo[filteredVacancies]": ()=>{
            if (!searchQuery) return vacancies;
            const query = searchQuery.toLowerCase();
            return vacancies.filter({
                "AdminVacanciesPage.useMemo[filteredVacancies]": (v)=>v.name.toLowerCase().includes(query) || v.category.toLowerCase().includes(query) || v.description.toLowerCase().includes(query)
            }["AdminVacanciesPage.useMemo[filteredVacancies]"]);
        }
    }["AdminVacanciesPage.useMemo[filteredVacancies]"], [
        vacancies,
...
_s(AdminVacanciesPage, "sYIby7e8XwOuJCV5BaTU+W0+p4k=", false, function() {
    return [
...
//# sourceMappingURL=src_08ce8819._.js.map