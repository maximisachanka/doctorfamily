...
function AdminUsersPage() {
        ...
        "AdminUsersPage.useMemo[filteredUsers]": ()=>{
            ...
            if (filterRole === 'admin') {
                result = result.filter({
                    "AdminUsersPage.useMemo[filteredUsers]": (u)=>u.role === 'ADMIN'
                }["AdminUsersPage.useMemo[filteredUsers]"]);
            } else if (filterRole === 'operator') {
                result = result.filter({
                    "AdminUsersPage.useMemo[filteredUsers]": (u)=>u.role === 'OPERATOR'
                }["AdminUsersPage.useMemo[filteredUsers]"]);
            }
            ...
            if (searchQuery) {
                ...
                result = result.filter({
                    "AdminUsersPage.useMemo[filteredUsers]": (u)=>u.name.toLowerCase().includes(query) || u.email && u.email.toLowerCase().includes(query) || u.phone && u.phone.toLowerCase().includes(query) || u.login.toLowerCase().includes(query)
                }["AdminUsersPage.useMemo[filteredUsers]"]);
            }
            return result;
        }
    ...
    // Count roles
    const adminsCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminUsersPage.useMemo[adminsCount]": ()=>{
            return users.filter({
                "AdminUsersPage.useMemo[adminsCount]": (u)=>u.role === 'ADMIN'
            }["AdminUsersPage.useMemo[adminsCount]"]).length;
        }
    }["AdminUsersPage.useMemo[adminsCount]"], [
        users
    ]);
    const operatorsCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminUsersPage.useMemo[operatorsCount]": ()=>{
            return users.filter({
                "AdminUsersPage.useMemo[operatorsCount]": (u)=>u.role === 'OPERATOR'
            }["AdminUsersPage.useMemo[operatorsCount]"]).length;
        }
    }["AdminUsersPage.useMemo[operatorsCount]"], [
        users
    ]);
    ...
    const paginatedUsers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminUsersPage.useMemo[paginatedUsers]": ()=>{
...
_s(AdminUsersPage, "i9rF+dmxHSM8J0udrEqKatlK4PA=", false, function() {
    return [
...
//# sourceMappingURL=src_8d84a593._.js.map