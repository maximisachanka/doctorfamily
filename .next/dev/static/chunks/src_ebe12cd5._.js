...
function AdminLettersPage() {
    ...
    // Filtered letters
    const filteredLetters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminLettersPage.useMemo[filteredLetters]": ()=>{
            let result = letters;
            // Filter by status
            if (filterStatus === 'unread') {
                result = result.filter({
                    "AdminLettersPage.useMemo[filteredLetters]": (l)=>!l.reply || l.has_new_patient_message
                }["AdminLettersPage.useMemo[filteredLetters]"]);
            ...
            if (searchQuery) {
                ...
                result = result.filter({
                    "AdminLettersPage.useMemo[filteredLetters]": (l)=>l.subject.toLowerCase().includes(query) || l.content.toLowerCase().includes(query) || l.patient.name.toLowerCase().includes(query) || l.patient.email.toLowerCase().includes(query)
                }["AdminLettersPage.useMemo[filteredLetters]"]);
            }
            return result;
        }
    ...
    const unreadCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminLettersPage.useMemo[unreadCount]": ()=>{
            return letters.filter({
                "AdminLettersPage.useMemo[unreadCount]": (l)=>!l.reply || l.has_new_patient_message
            }["AdminLettersPage.useMemo[unreadCount]"]).length;
        }
    }["AdminLettersPage.useMemo[unreadCount]"], [
        letters
    ]);
    ...
    const paginatedLetters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminLettersPage.useMemo[paginatedLetters]": ()=>{
...
_s(AdminLettersPage, "roLxqhlS5nI2CaW5Yyg8ht+gbVg=", false, function() {
    return [
...
//# sourceMappingURL=src_ebe12cd5._.js.map