    ...
    const filteredPartners = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminPartnersPage.useMemo[filteredPartners]": ()=>{
            ...
            return partners.filter({
                "AdminPartnersPage.useMemo[filteredPartners]": (p)=>p.name.toLowerCase().includes(query) || p.description.toLowerCase().includes(query) || p.category.name.toLowerCase().includes(query)
            }["AdminPartnersPage.useMemo[filteredPartners]"]);
        }
    }["AdminPartnersPage.useMemo[filteredPartners]"], [
        partners,
...
_s(AdminPartnersPage, "BaXB3ql2JJvjHM7Fu0DDOgo2IA8=", false, function() {
    return [
...
//# sourceMappingURL=src_e31257c4._.js.map